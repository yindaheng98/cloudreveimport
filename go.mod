module github.com/yindaheng98/cloudreveimport

go 1.18

require github.com/cloudreve/Cloudreve/v3 v3.0.0-20231007120838-88409cc1f0a0
...
require (
	...
	github.com/go-ini/ini v1.50.0 // indirect
